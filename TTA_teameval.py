...
def inference(args):
    ...
    dataset2 = basicDatasetA(data_dir=args.data_dir, mode='eval', transform=valid_transform2)
    ...
    with torch.no_grad():
        for idx, ((images1, labels), (images2, labels2)) in enumerate(zip(loader, loader2)):
